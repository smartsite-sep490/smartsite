...
Người dùng đã yêu cầu triển khai: React/Vite, NestJS, Expo/React Native, FastAPI trong hai repo. Node24.19.0, pnpm12.4.2, TypeScript6.0.3 được khóa để tương thích eslint; React Web19.3.0, Mobile19.2.3 theo Expo57.0.23/RN0.86.3. Nest12 chạy ESM. Tầng dữ liệu sử dụng TypeORM Data Mapper (@nestjs/typeorm, typeorm) và pg, synchronize: false; chưa có domain models/entities. Docker local PostgreSQL không thay quyết định Neon. OpenAI và YOLO/Supervision đã chốt hướng tích hợp, chưa triển khai inference/API calls. Các ghi chú nghiên cứu cũ dưới đây được đọc theo cập nhật này.
