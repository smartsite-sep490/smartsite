...
export function DashboardView({ onNavigate }: DashboardViewProps) {
  const stats = [
    ...
    },
    {
      ...
      value: '14',
      change: 'All compliant with onboarding',
      color: 'text-[#041D2E]',
    },
    {
    ...
    },
    {
      label: 'Open Alerts',
      value: '7',
      change: '3 urgent PPE, 4 zone checks',
      color: 'text-[#DF2225]',
    },
  ];
    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-[#62748E]">
            Real-time site presence, safety compliance and AI cameras.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {stats.map((s, idx) => (
          <div
            key={idx}
            className="bg-white p-5 rounded-xl border border-[#E2E8F0] shadow-xs space-y-1"
          >
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-xs text-[#62748E]">
                Worker entries and active zone presence today
              </p>
            </div>
